...
- `MONGO_DATABASE_URI` has been set in `farm-app/.env`; leaving the initial value as `mongodb` will establish a connection to the docker instance of mongo created.
